...
public class Discover {
	...
	public Discover(Discover discover) {
		this.id = discover.id;
		this.name = discover.name;
		this.description = discover.description;
		this.url = discover.url;
		this.timestamp = discover.timestamp;
		this.user = discover.user;
		this.upVote = discover.upVote;
		this.downVote = discover.downVote;
	}
